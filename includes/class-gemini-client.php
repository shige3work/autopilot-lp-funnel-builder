 ...
 *
 * Gemini 3.5 Flash-Lite APIとの連携およびURLスクレイピングを管理します。
 *
...
class Autopilot_LP_Funnel_Builder_Gemini_Client {
	 ...
	 * APIエンドポイントURL
	 */
	private $api_url = 'https://generativelanguage.googleapis.com/v1/models/gemini-3.5-flash-lite:generateContent';
